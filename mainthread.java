...
public class mainthread extends ConcreteObserver implements  Runnable{
	...
	mainthread(Subject subject, loc l1,pot p1,win wmain) {
...
//function that checks for the time and warns the player
